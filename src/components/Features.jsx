            ...
            <div className="screen-max-width">
                ...
                <div className="flex flex-col justify-center items-center overflow-hidden">
                    ...
                    <div className="flex-center flex-col sm:px-10">
                        <div className="relative h-[svh] w-full flex items-center">
                            <video
                                playsInline
                                id="explore_video"
                        ...
                        <div className="flex flex-col w-full relative mt-5">
                            ...
                            <div className="feature-text-container">
                                ...
                                <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">
                                        Titanium has one of the best strength to
                                        weight ratios of any metal, making it
                                        our{" "}
                                        <span className="text-white">
                                            lightest Pro models ever.
                                        </span>
                                        , you will notice the moment you pick
                                        one up.
                                    </p>
                                </div>
                            </div>
